...
MRDARKPRINCE = [
    ...
    "https://telegra.ph/file/3252842ed710915c55435.jpg",
        ...
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    ...
                    caption=f"""
**#⃣𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic Song added▪️Position {pos}
🏷️ Name: [{songname}]({link})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
...
""",
                        ...
                        try:
                            ...
                            await m.reply_photo(
                                photo=f"{IMAGE_THUMBNAIL}",
                                caption=f"""
**▶𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic Start Playing Song
🏷️ Name: [{songname}]({url})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
🎧 Requested by: {m.from_user.mention}**
""",
        ...
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/d6f92c979ad96b2031cba.png",
                    caption=f"""
**#⃣𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic 𝕍𝕚𝕕𝕖𝕠 𝓐𝓭𝓭𝓮𝓭▪️Position {pos}
🏷️ Name: [{songname}]({link})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
🎬 Requested by: {m.from_user.mention}**
""",
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/6213d2673486beca02967.png",
                    caption=f"""
**▶𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic Start Playing ᐯIᗪᗴO
🏷️ Name: [{songname}]({link})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
                ...
                if hm == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        await m.reply_photo(
                            photo=f"{IMAGE_THUMBNAIL}",
                            caption=f"""
**#⃣𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic 𝙑𝙞𝙙𝙚𝙤 𝘼𝙙𝙙𝙚𝙙▪️Position {pos}
🏷️ Name: [{songname}]({url})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
🎬 Requested by: {m.from_user.mention}**
""",
                        ...
                        try:
                            ...
                            await m.reply_photo(
                                photo=f"{IMAGE_THUMBNAIL}",
                                caption=f"""
**▶𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic Start Playing Video
🏷️ Name: [{songname}]({url})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
🎬 Requested by: {m.from_user.mention}**
""",
            ...
            async for x in bot.search_messages(chat, limit=limit, filter="audio"):
                ...
                if chat_id in QUEUE:
                    ...
                    await m.reply_photo(
                        photo="https://telegra.ph/file/6213d2673486beca02967.png",
                        caption=f"""
**▶𓆩𐌺ᏒᎥ𓆪◞🖤✨ Ⲙusic Start Playing Songs From {chat}
🏷️ Name: [{songname}]({link})
❤ Oᴡɴᴇʀ: [⚡༞ ⃪˚𓆩〭〬×⃪⃕͜×𓆪〭〬 |⁪⁬⁮⁮⁮⁮ 𝘿𝙑𝙔𝙎𝙃 ✰⁣⃝❥⏤͟͟͞͞🖤♛](https://t.me/zaynxop)
